...
class UserAnswer(db.Model):
    ...
    answer_ipfs = db.Column(db.String(128))
...
class User(db.Model, UserMixin):
    ...
    Ethereum_account = db.Column(db.String(128), index=True)
...
class Survey(db.Model):
    ...
    survey_ipfs = db.Column(db.String(128))
    geth_address = db.Column(db.String(128))
    geth_abi = db.Column(db.Text)
